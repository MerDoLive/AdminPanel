        ...
        <div class="row">
            <div class="card">
                ...
                <div class="col-sm-10 col-md-10 col-lg-10" style="padding:100px 10px; margin:auto;float:none; ">
                 <form class="form-horizontal" id="seller_form" role="form" style="padding:15px;" method="post" action="<?php echo base_url()?>index.php/Seller_request/update_action" enctype="multipart/form-data">
                        <?php 
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <button type="button" class="btn btn-sm btn-danger" onclick="window.location='<?= site_url('Seller_Request') ?>'" >Back</button>
                                </div>
                            </div>
                        </div>
                    </form>
