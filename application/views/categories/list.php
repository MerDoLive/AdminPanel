            ...
            <div class="card">
                <div class="card-header">
                   ...
                   <div class="col-md-4 text-right">
                        <a class="btn btn-primary" href="<?= site_url('Categories/create/'.$cond2) ?>">Add </a>
                    </div>
                    <br><br><br><br><br><br><br>

                    <div class="col-md-12 text-left">    
                        <a class="btn btn-secondary" href="<?= site_url('Categories/index/ALL') ?>">ALL(<?= $all?>) </a>
                        <a class="btn btn-secondary" href="<?= site_url('Categories/index/LIVE') ?>">LIVE(<?= $live?>) </a>
                        <a class="btn btn-secondary" href="<?= site_url('Categories/index/PNDG') ?>">PENDING(<?= $pndg?>)</a>
                        <a class="btn btn-secondary" href="<?= site_url('Categories/index/REJ') ?>">REJECTED(<?= $rej?>)</a>
                        <a class="btn btn-secondary" href="<?= site_url('Categories/index/DLTD') ?>">DELETED(<?= $deleted?>)</a> 
                    </div>
                    <div style="clear:both"></div>
                </div>
                
<div class="col-md-12 text-right">
                            <a class="btn btn-secondary" href="<?= site_url('Categories/export') ?>">EXPORT
                </a></div>
                <div class="table-responsive" style="padding: 20px">
                    <table id="server_table" class="table table-bordered table-hover">
                        <thead>
                            <tr id='maintable' class='info'>
                                <th><b class="text-primary">Sr No</b></th>
                                <th><b class="text-primary">Category Type</b></th>
                                <th><b class="text-primary">Category Level 1 ID</b></th>
...
<script>
    var url = '<?= site_url('Categories/ajax_manage_page/'.$cond2)?>';
    var actioncolumn=5;
</script>
