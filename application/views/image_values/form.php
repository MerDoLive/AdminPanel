                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="col-md-6">
                                <div class="form-group" id="pcat">
                                    <label>Parent Type <span class="err">*</span></label>
                                    <div class="fg-line">
                                       <select id="categoryId" name="entityId" class="form-control input-sm">
                                        <option value='0'>First Select Group </option>
                                            <!-- <?php //foreach($mainCategory as $category){ ?>
                                              <option value="<?php //echo $category->CATG_MSTR_CATEGORY_ID ?>" <?php //if($category->CATG_MSTR_CATEGORY_ID==$entityId){ echo 'selected'; } ?>> <?php //echo $category->CATG_MSTR_CATEGORY_NAME ?>
                                              </option>
                                           <?php // } ?>   -->                                    
                                       </select>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12" id="pos">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="fg-line">
                                        <input type="text" class="form-control input-sm" name="position" placeholder="Priority for banner image" id="position" value="<?= $position; ?>">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <button type="button" class="btn btn-sm btn-danger" onclick="window.location='<?= site_url('Image_Values') ?>'" >Back</button>
                                </div>
                            </div>
                        </div>
                    </form>
...
$("#name").change(function (e) {
    ...
    if ((file = this.files[0])) {
        ...
        img.onload = function () {
            var wd=this.width;
            var ht=this.height;
            var diawd=$("#imgwidth").val();
            var diaht=$("#imgheight").val();
             if(diawd<wd || diaht<ht)
                {
                    swal({
                      title: "Your Image is not Valid.",
                      text: "Your Image width is "+wd+" & height is "+ht+"\n Please Resize your Image Diamention in "+diawd+"px Width and "+diaht+"px Height",
                      icon: "error",
                      buttons: true,
                      dangerMode: true,
                    }).then((value)=> {
                    ...
                    // alert("Your Image width is "+wd+" & height is "+ht+"\n Please Resize your Image Diamention in "+diawd+"px Width and "+diaht+"px Height");
                    // location.reload();
                }
            // else{ alert("Your Image width is "+wd+" & height is "+ht); return true; }
        };
