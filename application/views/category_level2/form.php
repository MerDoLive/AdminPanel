                ...
                <div class="table-responsive">
                    <form method="post" action="<?= $action ?>" id="loginform" enctype="multipart/form-data" >
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <!-- <div class="col-md-2">
                                <button type="button" class="btn btn-sm btn-danger" onclick="window.location='<?= site_url('Categories_type/createMasterType') ?>'" >Add Category Type</button>
                            </div> -->
                        </div>
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Category Level1 <span class="err">*</span></label>
                                    <div class="fg-line">
                                       <select id="categorylevel1Id" name="maincategoryId" class="form-control input-sm">
                                          ...
                                          <?php if($category->CATG_MSTR_CATEGORY_ID==$mainCategoryId){?>
                                              <option value="<?php echo $category->CATG_MSTR_CATEGORY_ID?>" selected > <?php echo $category->CATG_MSTR_CATEGORY_NAME ?>
                                              </option>
                                           <?php } } ?>                                         
                                       </select>
                                    <div><span class="err"><?= form_error('categorylevel1Id') ?></span></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                          ...
                          <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="fg-line">
                                        <textarea type="text"  class="form-control input-sm ckeditor" name="desc" placeholder="Description" id="desc" row="6" required><?= $desc ?></textarea>   </div>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <button type="submit" class="btn btn-sm btn-primary" onclick="desc"><?= $button ?></button>
           ...
           $('#categorytype').on('change', function(){
            ...
            if(categorytype == '')
                ...
                else
                {
                    ...
                    $.ajax({
                    url:"<?php echo site_url(); ?>/Categories_level2/get_category1",
