            ...
            <div class="card">
                <div class="card-header">
                   ...
                   <div class="col-md-4 text-right">
                        <a class="btn btn-primary" href="<?= site_url('Categories_level2/create/'.$cond2) ?>">Add </a>
                    </div>
                    <br><br><br><br><br><br><br>

                    <div class="col-md-12 text-left">    
                        <a class="btn btn-secondary" href="<?= site_url('Categories_level2/index/ALL') ?>">ALL(<?= $all?>) </a>
                        <a class="btn btn-secondary" href="<?= site_url('Categories_level2/index/LIVE') ?>">LIVE(<?= $live?>) </a>
                        <a class="btn btn-secondary" href="<?= site_url('Categories_level2/index/PNDG') ?>">PENDING(<?= $pndg?>)</a>
                        <a class="btn btn-secondary" href="<?= site_url('Categories_level2/index/REJ') ?>">REJECTED(<?= $rej?>)</a>
                        <a class="btn btn-secondary" href="<?= site_url('Categories_level2/index/DLTD') ?>">DELETED(<?= $deleted?>)</a> 
                    </div>
                    <div style="clear:both"></div>
                </div>
<div class="col-md-12 text-right">
                            <a class="btn btn-secondary" href="<?= site_url('Categories_level2/export') ?>">EXPORT
                </a></div>
                    ...
                    <table id="server_table" class="table table-bordered table-hover">
                        <thead>
                            <tr class='info'>
                                ...
                                <th><b class="text-primary">Category Level 2 ID</b></th>
...
<script>
    var url = '<?= site_url('Categories_level2/ajax_manage_page/'.$cond2)?>';
    var actioncolumn=6;
</script>
...
<div class="modal fade" id="checkStatus" data-modal-color="white" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">   
            <form method="post" action="<?= site_url('Categories_level2/changeStatus') ?>">       
