        ...
        <div class="container">
            <div class="card">
                <div class="card-header">
                    <div class="col-md-4" style="padding: 0"><h3><i class="zmdi zmdi-city"></i>&nbsp;<?= $heading ?></h3></div>
                    ...
                    <div class="col-md-4 text-right">
                        <a class="btn btn-primary" href="<?= site_url('Cities/create') ?>">Add </a>
                    </div>
...
<div class="modal fade" id="checkStatus" data-modal-color="lightblue" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" aria-hidden="true">
            ...
            <form method="post" action="<?= site_url('Cities/delete') ?>">       
                <div class="modal-body" style="height: 120px;padding-top: 3%">
                    <center>
                        ...
                        <span style="font-size: 16px">If you want delete this city, all associated things will be deleted permanently. Are you sure?</span>
                    </center>
                </div>
                <div class="modal-footer">
                    <button type="submit" class="btn btn-link">Ok</button>
