            ...
            <?php } ?>
               ...
               <div class="card-body table-responsive">
                  <table class="table table-striped table-dark table-hover">
                    ...
                    echo "<tr><td>".$attr->PRODUCT_ATTR_MAP_ATTR_NAME."</td><td>".$attr->PRODUCT_ATTR_MAP_ATTR_VALUES."</td></tr>";
                    }
                   ?>

<tr><td colspan='2'> <div class="gallery">
...
<div class="gallery">
  ...
  <?php
                    foreach($img as $img1){
                    echo "<a target='_blank' href='".base_url()."uploads/images/".$img1->IMAGE_MSTR_IMAGE_NAME."'><img src='".base_url()."uploads/images/".$img1->IMAGE_MSTR_IMAGE_NAME."' class='img-thumbnail' width='100' height='100'>";
                    }
                    ?>
</div></td></tr>
